...
const fruits = [
  {
    ...
    price: "$40.29",
    discount: "$60.29",
    description: "Fuerte avocado, or Persea americana 'Fuerte,' is a popular and delicious avocado variety known for its smooth, pear-shaped fruit. This avocado cultivar is native to Central America and is widely cultivated in various parts of the world with suitable climates"
  },
  {
    id: 2,
    name: "Hass Avocado",
  ...
  },
  {
    ...
    price: "$40.29",
    discount: "$60.29",
    description: "The apple banana, also known as the Manzano banana or the Apple Cultivar, is a distinct banana variety characterized by its small size and apple-like flavor. Its creamy, sweet flesh and unique taste make it a favorite among banana enthusiasts. "
  },
  {
    id: 4,
    name: "Pineapple",
    ...
    price: "$40.29",
    discount: "$60.29",
    description: "Pineapple is a tropical fruit renowned for its sweet and tangy flavor. It is characterized by its spiky, rough skin and vibrant yellow or orange flesh. Pineapples are known for their juicy, succulent texture and a refreshing taste that strikes a perfect balance between sweetness and acidity."
  },
  {
    id: 5,
