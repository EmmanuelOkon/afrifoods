import aboutIntroWoman from "../../assets/images/aboutIntroWoman.png";
        ...
        <div className=" mx-auto">
          <div className="py-6 lg:py16">
            <div className="px-4 xl:px-[100px]  bg-white ">
              <div className="flex flex-col gap6 items-center md:gap[4rem] lg:flex-row lg:justify-between w-full">
                ...
                <div className="lg:w-1/2 h-auto justify-center">
                  <img
                    className="w[80%] h-auto md:w[60%] lg:w-full lg:h[500px] lg:w[750px] "
                    src={aboutIntroWoman}
                    alt="aboutIntroWoman"
                  />
                </div>
