...
const AboutStandOut = () => {
  return (
    ...
    <div className="py-10 px4 sm:px8 max-w7xl mx-auto">
      <div className="relative overflow-hidden z-10 justify-center items-center w-full h-full lg:h-[720px] py-20 bg-gradient-to-b from-deepGreen via-midGrey to-deepGreen ">
